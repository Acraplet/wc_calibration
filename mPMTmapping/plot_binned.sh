...
then
    ...
    python src/read_txtMap_binned.py -f maps_txtFiles/mPMT_map_ID$ID_1.txt -c maps_txtFiles/mPMT_map_ID$ID_2.txt -o "comparision_FileID"$ID_1"_FileID"$ID_2""$mode""
fi
