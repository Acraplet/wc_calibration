...
//         std::cout<<"event: "<<event<< " NHits " << NHits <<std::endl;
    ...
    std::string onePosition_outfile = Form("/home/ac4317/Laptops/Year1/WCTE/wc_calibration/mPMTmapping/maps_Reference/OnePosition_theta%s_phi%s_R%s.txt", theta, phi, dist);
